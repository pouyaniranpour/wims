...
import orangeArrow from '../../assets/startingPage/orangeArrow.png'
...
function StartingPage() {
  ...
  return (
       <div className={`${location === '/startingPage'? 'opacity-100 z-10': 'opacity-0 -z-10'} absolute top-0 left-0 transition-opacity duration-500 ease-in-out set-0 grid grid-cols-2 h-full w-full`}>
        <div className="h-full w-full bg-[#27272A] flex flex-col justify-center items-center text-zinc-300 font-bebas-neue">
          ...
          <a className="mt-28 w-fit flex items-center hover:text-zinc-50" href="https://www.housingfirst.co.nz/data-and-evidence/aucklands-homeless-count/" target="_blank">
            ...
            <img className="w-[120px] brightness-200 absolute top-11 left-11" src={logo} alt="acm logo"/>
        ...
        <div className="flex flex-col relative left-16"><p className="font-viga text-2xl text-zinc-800">Walk My Life</p>
          <Link to={"/gettingStarted"}>
            <div className="cursor-pointer flex justify-center items-center relative bottom-4"><p className="text-large font-bebas-neue text-dark-orange">PLAY GAME</p>
              <img className="ml-2" src={orangeArrow} /></div>
          </Link>
