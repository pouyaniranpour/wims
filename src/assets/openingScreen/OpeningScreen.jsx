  ...
  return (
      ...
      <div className={`${location === '/'? 'opacity-100 z-10': 'opacity-0 -z-10'} transition-opacity duration-1000 ease-in-out bg-gradient-to-t from-[#E5F7FB] to-white absolute inset-0 flex flex-col items-center justify-center size-full`}>
        ...
        <img className="w-3/4 absolute bottom-0 fadeInCityscape" src="/landingPage/acm-cityscape.svg" alt="acm cityscape" />
              ...
              <Link to='/startingPage'><div onClick={handleBeginButton} className="-z-20 hover:cursor-pointer absolute bottom-50 right-96 bg-white shadow-custom-darker flex justify-center items-center rounded-full border border-black w-64 h-12 text-xl font-ibm-plex-sans fadeInButton">Let's begin</div></Link>
